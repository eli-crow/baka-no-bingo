...
import { Player, PlayerOptions, createPlayer } from 'shared/src/player.js';
import { AppSocket, AppSocketServer } from '../types/socket.js';
  ...
  private handleConnection(socket: AppSocket) {
    ...
    socket.on('disconnect', () => {
      try {
        ...
        if (e instanceof PlayerNotFoundError) return;
        throw e;
      }
    });
